        ...
        <div className='flex-grow max-w-4xl mx-auto px-4'>
            ...
            <div className='flex items-center justify-center mt-12'>
                <button
                    ...
                    className='bg-buttonColor w-40 text-white font-bold p-4 rounded-full border-2 border-buttonBorder hover:scale-110 hover:shadow-xl transition duration-150'
                >
                    Contact Me
                </button>
            </div>
